 ...
 * datos enviados y comprueba que estos son los correctos, se haria lanzando el primer metodo de
 * la clase EnviarXmlActionTest
 */
public class ServerITTest {
    ...
    /**
     * en este caso habria que lanzar el segundo test de EnviarXmlActionTest que envia un identificador distinto al esperado
     * @throws IOException
     */
    @Test
